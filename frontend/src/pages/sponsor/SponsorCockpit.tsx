...
// Gantt) and watches their money: spend-vs-progress headline, read-only budget +
// invoices, an assurance feed, and the ONE action a sponsor takes — RELEASE a
// payment milestone once its phase is AI-verified complete (sign-off captured).
//
// Read-only finance everywhere; the only write is the fund release, gated by
// canReleasePaymentMilestone + deploy-gated to migration 49 (degrades gracefully).
  ...
  return (
    <div className="editorial-root min-h-full bg-[#FAF8F2]">
      <div className="mx-auto w-full max-w-[1100px] px-4 py-6 sm:px-8 sm:py-8">
        ...
        {/* Assurance feed — proof their money built something real */}
